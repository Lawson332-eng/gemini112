<?php
/**
 * Child Theme Functions - Final Text Buttons Version
 * 最终文字按钮版 - 三个按钮统一样式和间距
 *
...
function get_app_button_styles() {
    ...
    /* 确保按钮内没有额外的容器边框 */
    .custom-product-buttons-container > *:not(a),
    ...
    /* 强制移除所有可能的父容器边框 */
    .custom-product-buttons-container [class*="yith"]:not(a),
    .custom-product-buttons-container [class*="ywraq"]:not(a),
